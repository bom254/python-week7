...
plt.plot(df['GRE Score'], df['Chance of Admit '], marker='o', linestyle='--')
...
plt.figure(figsize=(10, 5))
plt.bar(mean_admit_chance.index, mean_admit_chance.values, color=['orange', 'green'])
...
plt.figure(figsize=(10, 5))
plt.hist(df['CGPA'], bins=10, color='purple', edgecolor='black')
...
plt.figure(figsize=(10, 5))
plt.scatter(df['GRE Score'], df['CGPA'], c=df['Research'], cmap='coolwarm', edgecolor='k')
